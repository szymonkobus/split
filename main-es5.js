...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_mat_list_option_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_mat_list_option_17_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-list-option", 21);
    ...
    function AppComponent_ng_container_28_th_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_ng_container_28_td_2_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_ng_container_28_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var Wager = /*#__PURE__*/function () {
      function Wager() {
        _classCallCheck(this, Wager);
      ...
      _createClass(Wager, [{
        key: "addTransaction",
        value: function addTransaction(cost, payer_obj, payees_obj) {
          // validate input
          if (cost <= 0 || isNaN(cost) || payer_obj.length == 0 || payees_obj.length == 0) {
            return;
          }

          var payees = payees_obj.map(function (e) {
            return e._value;
          });
          var payer = payer_obj[0]._value;
          var part = cost / payees_obj.length;
          var last_state = this.transaction_history[0];
          var new_state = {};

          for (var key in last_state) {
            new_state[key] = {
              balance: last_state[key].balance,
              change: 0
            };
          }

          var _iterator = _createForOfIteratorHelper(payees),
              _step;

          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var payee = _step.value;
        ...
        value: function addPerson(name) {
          ...
          this.transaction_history.map(function (dic) {
            dic[name] = {
              balance: 0,
              change: 0
            };
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(route) {
        ...
        this.route.queryParams.subscribe(function (params) {
          ...
          var _iterator2 = _createForOfIteratorHelper(params.ppl.split(";")),
              _step2;
      ...
      _createClass(AppComponent, [{
        ...
        key: "addRow",
        value: function addRow(cost, payer, payees_obj, HTMLtable) {
          console.log(payer);
      ...
      template: function AppComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_24_listener() {
            ...
            return ctx.addRow(_r4.valueAsNumber, _r0.selectedOptions.selected, _r2.selectedOptions.selected, _r5);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_button_click_37_listener() {
            ...
            return ctx.addColumn(_r9.value);
          });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./node_modules/@angular/platform-browser/__ivy_ngcc__/fesm2015/animations.js"); //import {Component, ViewChild} from '@angular/core';
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_9__["AppRoutingModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_3__["MatButtonModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_4__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_5__["MatInputModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_6__["MatRadioModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_7__["MatListModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_8__["ReactiveFormsModule"], //ViewChild,
      //Component,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/szymonkobus/Documents/projects/023_split/split/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
