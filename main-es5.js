...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function AppComponent_mat_list_option_12_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-list-option", 19);
    ...
    function AppComponent_ng_container_23_th_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AppComponent_ng_container_23_td_2_Template(rf, ctx) {
      if (rf & 1) {
